        ...
        <footer className="bg-[#111111] text-white py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <Link href="/" className="mb-4 block">
                            <span className="text-xl md:text-2xl font-black italic tracking-tighter text-[#EF4444]">MOTO<span className="text-gray-200">EKİPMAN</span><span className="text-sm text-gray-500 ml-1">2.EL</span></span>
                        </Link>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
                    <div>
                        &copy; {new Date().getFullYear()} MotoEkipman2.El. Tüm hakları saklıdır.
                    </div>
                    <div>
